...
du52 v0 v1
  = coe
      ...
      (coe
         (\ v2 ->
            coe
              d28 v1 (coe MAlonzo.Code.Data.Fin.Base.du372 (coe v0) (coe v2))))
...
du132 v0 v1
  = coe MAlonzo.Code.Data.List.Base.du362 (coe v0) (coe d28 (coe v1))
name136 = "Data.Table.Base.fromList"
d136 :: MAlonzo.Code.Agda.Primitive.T4 -> () -> [AgdaAny] -> T20
d136 v0 v1 v2 = du136 v2
du136 :: [AgdaAny] -> T20
du136 v0 = coe C30 (coe MAlonzo.Code.Data.List.Base.du372 (coe v0))
