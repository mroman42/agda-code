      ...
      C136 v3 v4
        -> let v6
                 = coe
                     ...
                     (coe MAlonzo.Code.Data.Nat.Properties.d4830 (coe v3) (coe v0)) in
           case coe v6 of
             MAlonzo.Code.Data.Nat.Base.C170 v7
               -> coe
  ...
  = case coe v3 of
      C136 v4 v5
        -> let v7
                 = coe
                     MAlonzo.Code.Relation.Nullary.du60 (coe ())
                     (coe MAlonzo.Code.Data.Nat.Properties.d4830 (coe v4) (coe v0)) in
           case coe v7 of
             MAlonzo.Code.Data.Nat.Base.C170 v8
               -> coe
                    MAlonzo.Code.Data.Vec.Base.du190
                    (coe
                       MAlonzo.Code.Data.Vec.Base.du490
                       (coe MAlonzo.Code.Data.Nat.Base.d94 (coe v8)) (coe v1))
                    (coe
                       MAlonzo.Code.Data.Vec.Base.du190 (coe v5)
                       (coe
                          MAlonzo.Code.Data.Vec.Base.du490
                          (coe MAlonzo.Code.Data.Nat.Base.d98 (coe v8)) (coe v2)))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
du284 v0
  = coe
      du140 (coe MAlonzo.Code.Data.List.Base.du258 v0)
  ...
  = case coe v1 of
      C136 v3 v4
        -> case coe v2 of
             C136 v6 v7
               -> coe
                    C136 (MAlonzo.Code.Data.Nat.Base.d74 (coe v3) (coe v6))
  ...
  = case coe v1 of
      C136 v3 v4
        -> case coe v2 of
             C136 v6 v7
               -> coe
                    C136 (MAlonzo.Code.Data.Nat.Base.d84 (coe v3) (coe v6))
...
du452 v0
  = coe
      MAlonzo.Code.Data.List.Relation.Unary.All.Properties.du802 (coe v0)
      (coe
