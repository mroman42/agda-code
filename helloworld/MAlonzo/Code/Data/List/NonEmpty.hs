  ...
  = case coe v0 of
      C34 v1 v2
        -> coe
             ...
             (coe MAlonzo.Code.Data.List.Base.du258 v2)
      _ -> MAlonzo.RTE.mazUnreachableError
...
du180 v0 v1
  = coe
      MAlonzo.Code.Data.List.Base.du202 (coe du46) (coe v1) (coe v0)
        ...
        -> case coe v2 of
             C34 v5 v6
               -> coe
                    ...
                    (coe MAlonzo.Code.Data.List.Base.du96 (coe v0) (coe v4) (coe v6))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
      ...
      C34 v3 v4
        -> case coe v2 of
             C34 v5 v6
               -> coe
                    C34 (coe v0 v3 v5)
                    (coe MAlonzo.Code.Data.List.Base.du116 (coe v0) (coe v4) (coe v6))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
du252 v0 v1
  = case coe v0 of
      ...
      (:) v2 v3
        -> coe
             C34 (coe v2)
             (coe MAlonzo.Code.Data.List.Base.du764 (coe v3) (coe v1))
      _ -> MAlonzo.RTE.mazUnreachableError
...
du284 v0
  = case coe v0 of
      C34 v1 v2
        -> let v3 = coe MAlonzo.Code.Data.List.Base.du798 (coe v2) in
           case coe v3 of
             MAlonzo.Code.Data.List.Base.C788
               -> coe C280 (coe MAlonzo.Code.Agda.Builtin.List.C16) (coe v1)
             MAlonzo.Code.Data.List.Base.C794 v4 v5
               -> coe
                                ...
                                (coe
                                   ...
                                   (coe
                                      ...
                                      (coe
                                         MAlonzo.Code.Function.Equality.d38
                                         (MAlonzo.Code.Function.Equivalence.d36
                                            (coe MAlonzo.Code.Data.Bool.Properties.d2030 (coe v4)))
                                         erased))
                                   (coe MAlonzo.Code.Agda.Builtin.List.C16)))
                             (coe v5) in
                   case coe v5 of
                                      ...
                                      (coe
                                         ...
                                         (coe
                                            ...
                                            (coe
                                               ...
                                               (MAlonzo.Code.Function.Equivalence.d36
                                                  (coe
                                                     MAlonzo.Code.Data.Bool.Properties.d2030
                                                     (coe v4)))
                                               erased))
                                         (coe v9)))
                                   (coe v8)
