        ...
        -> case coe v1 of
             (:) v7 v8
               -> coe
                    ...
                    (coe
                       MAlonzo.Code.Data.List.Relation.Unary.All.du208 (coe v0 v7)
                       (coe v8) (coe v5))
                      ...
                      -> case coe v4 of
                           MAlonzo.Code.Data.List.Relation.Unary.AllPairs.Core.C28 v13 v14
                             -> coe
                                  MAlonzo.Code.Data.List.Relation.Unary.AllPairs.Core.C28
                                  (coe
                                     MAlonzo.Code.Data.List.Relation.Unary.All.du236 (coe v0 v9)
                                     (coe v10)
               ...
               -> coe
                    ...
                    (coe
                       (\ v9 v10 ->
                          coe MAlonzo.Code.Data.List.Relation.Unary.AllPairs.Core.C28))
                    (coe
                       MAlonzo.Code.Data.List.Relation.Unary.All.du250 (coe v0 v7)
                       (coe v8) (coe v5))
      ...
      (:) v2 v3
        -> coe
             ...
             (coe
                ...
                (coe
                   MAlonzo.Code.Data.List.Relation.Unary.All.du528 (coe v0 v2)
                   (coe v3))
