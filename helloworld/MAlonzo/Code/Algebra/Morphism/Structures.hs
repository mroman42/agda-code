...
data T72
  = C769 MAlonzo.Code.Relation.Binary.Morphism.Structures.T40
         (AgdaAny -> AgdaAny -> AgdaAny)
name80
...
du110 v0
  = coe
      MAlonzo.Code.Relation.Binary.Morphism.Structures.C1021
...
du140 v0
  = coe
      MAlonzo.Code.Relation.Binary.Morphism.Structures.C2077
...
d434 :: T72 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T40
d434 = coe d80
name446
...
d560 ::
  T542 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T40
...
d586 ::
  T568 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T40
...
d600 ::
  ...
  MAlonzo.Code.Algebra.Bundles.T742 ->
  (AgdaAny -> AgdaAny) ->
  T568 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T62
...
d628 ::
  T604 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T40
d628 v0
...
d630 ::
  ...
  MAlonzo.Code.Algebra.Bundles.T742 ->
  (AgdaAny -> AgdaAny) ->
  T604 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T62
...
d644 ::
  ...
  MAlonzo.Code.Algebra.Bundles.T742 ->
  (AgdaAny -> AgdaAny) ->
  T604 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T92
...
d864 ::
  ...
  MAlonzo.Code.Agda.Primitive.T4 ->
  MAlonzo.Code.Algebra.Bundles.T1986 ->
  MAlonzo.Code.Algebra.Bundles.T1986 -> (AgdaAny -> AgdaAny) -> ()
d864 = erased
...
d898 ::
  T876 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T40
...
d950 ::
  T918 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T40
d950 v0
...
d966 ::
  ...
  MAlonzo.Code.Algebra.Bundles.T1986 ->
  (AgdaAny -> AgdaAny) ->
  T918 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T62
...
d1008 ::
  T970 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T40
d1008 v0
  = coe
...
d1012 ::
  ...
  MAlonzo.Code.Algebra.Bundles.T1986 ->
  (AgdaAny -> AgdaAny) ->
  T970 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T62
...
d1028 ::
  ...
  MAlonzo.Code.Algebra.Bundles.T1986 ->
  (AgdaAny -> AgdaAny) ->
  T970 -> MAlonzo.Code.Relation.Binary.Morphism.Structures.T92
