...
du68 v0
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C1529 (coe du66) (coe v0)
...
du72
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C2113 (coe du66)
...
du74 = coe MAlonzo.Code.Relation.Binary.Bundles.C501 (coe du66)
...
du78 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T84
du78 v0
  = coe MAlonzo.Code.Relation.Binary.Bundles.C939 (coe du68 (coe v0))
name82 = "Relation.Binary.PropositionalEquality.preorder"
d82 ::
  MAlonzo.Code.Agda.Primitive.T4 ->
  () -> MAlonzo.Code.Relation.Binary.Bundles.T132
d82 v0 v1 = du82
du82 :: MAlonzo.Code.Relation.Binary.Bundles.T132
du82 = coe MAlonzo.Code.Relation.Binary.Bundles.C1509 (coe du72)
...
d412 v0 v1 v2 = du412
du412 :: MAlonzo.Code.Algebra.Structures.T80
du412 = coe MAlonzo.Code.Algebra.Structures.C423 (coe du66) erased
...
du418 ::
  (AgdaAny -> AgdaAny -> AgdaAny) -> MAlonzo.Code.Algebra.Bundles.T30
du418 v0 = coe MAlonzo.Code.Algebra.Bundles.C255 v0 (coe du412)
