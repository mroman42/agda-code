...
newtype T40 = C359 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
name50
...
data T62 = C1021 T40 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
name74
...
data T92
  = C2077 T62 (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14)
name104
...
du158 :: T136 -> T40
du158 v0 = coe C359 (coe d152 (coe v0))
name160
...
du214 :: T180 -> T62
du214 v0
  = coe C1021 (coe du158 (coe d198 (coe v0))) (coe d200 (coe v0))
name216
...
du266 :: T236 -> T40
du266 v0 = let v1 = d252 (coe v0) in coe du160 (coe d198 (coe v1))
name268
...
du274 :: T236 -> T92
du274 v0
  = coe C2077 (coe du214 (coe d252 (coe v0))) (coe d254 (coe v0))
